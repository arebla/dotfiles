...
HTML_STREAK: str = """
<div class="streak">
    <span class="streak-info">Media diaria:</span>
    <span title="Media de repasos en días activos."
        class="sstats {class_activity_daily_avg}">{text_activity_daily_avg}</span>
    <span class="streak-info">Días aprendendo:</span>
    <span title="A porcentaxe de días nos que repasaches fronte ao total do historial."
        class="sstats {class_pct_days_active}">{text_pct_days_active}%</span>
    <span class="streak-info">Xeira máis longa:</span>
    <span title="Maior xeira no historial de repaso. Inclúense todos os tipos de repeticións."
        class="sstats {class_streak_max}">{text_streak_max}</span>
    <span class="streak-info">Xeira actual:</span>
    <span title="Xeira actual de repasos de tarxetas. Inclúense todos os tipos de repeticións."
